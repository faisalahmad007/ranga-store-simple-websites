...
const showProducts = (products) => {
  ...
  <img class="product-image" src=${product.image}></img>
    ...
    <p> Ratings:${product.rating.rate}<span>/(${product.rating.count})</span></p>
...
const addToCart = (id, price) => {
  ...
  updateTaxAndCharge();
  document.getElementById("total-Products").innerText = parseFloat(count.toFixed(2));
};
